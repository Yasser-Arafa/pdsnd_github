...
def get_filters():
    ...
    city = input("Please input on of the cities name (chicago, new york city, or washington) \n: ").lower()
...
def station_stats(df):
    ...
    print("The most frequent combination of start and end station trip is: {}".format(
